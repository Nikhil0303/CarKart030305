...
cartApp.controller("addToCartCtrl", function ($scope, $http){
    ...
    $scope.addItemToCart = function (itemId) {
        ...
        $http.post('http://localhost/CarKart030305/usercart/cart/addItem/'+itemId).success(function () {
    ...
    $scope.clearCartItems = function () {
    	$http['delete']('http://localhost/CarKart030305/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
    };
});